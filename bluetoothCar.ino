...
void left()
{
  ...
  motor3.setSpeed(120); //Left wheel
  motor3.run(BACKWARD);  //rotate the motor clockwise
  motor4.setSpeed(190); //Right wheel
  motor4.run(FORWARD);  //rotate the motor clockwise
}
...
void right()
{
  ...
  motor3.setSpeed(190); //Left wheel
  motor3.run(FORWARD); //rotate the motor anti-clockwise
  motor4.setSpeed(120); //Right wheel
  motor4.run(BACKWARD); //rotate the motor anti-clockwise
}
...
void fright()
{
  ...
  motor2.setSpeed(255); //Define maximum velocity
  motor2.run(BACKWARD); //rotate the motor anti-clockwise
  motor3.setSpeed(180); //Left wheel
  motor3.run(FORWARD);  //rotate the motor clockwise
  motor4.setSpeed(120); //Right wheel
  motor4.run(FORWARD);  //rotate the motor clockwise
}
